...
<div class="container">
            ...
            <div class="row bs-wizard hidden-print" style="border-bottom:0;">
                ...
                <div class="col-xs-3 bs-wizard-step <?php if ($TIPO==0){echo ' active ';} elseif ($TIPO>0){echo ' complete ';} ?>">
                ...
                <div class="col-xs-3 bs-wizard-step <?php if ($TIPO==1){echo ' active ';} elseif ($TIPO>1){echo ' complete ';} elseif($TIPO<1){echo ' disabled ';} ?>"><!-- complete -->
                ...
                <div class="col-xs-3 bs-wizard-step <?php if ($TIPO==2){echo ' active ';} elseif ($TIPO>2){echo ' complete ';} elseif($TIPO<2){echo ' disabled ';} ?>"><!-- complete -->
                ...
                <div class="col-xs-3 bs-wizard-step <?php if ($TIPO==3){echo ' active ';} elseif ($TIPO>3){echo ' complete ';} elseif($TIPO<3){echo ' disabled ';} ?>"><!-- active -->
