...
<body>
        ...
        <div class="container">
            <div class="navbar-collapse collapse">
                <ul class="nav navbar-nav navbar-left">
                    ...
                    <li><a href="#">Viaggiare sicuri</a>
                    </li>
                    <!-- Link dropdown -->
                    <li class="dropdown"><a href="./index.php" class="dropdown-toggle" data-toggle="dropdown">Categorie<span
                        class="caret"></span></a>
                        <ul class="dropdown-menu" role="menu">
                            ...
                            <li><a href="#">Famiglia</a>
                            </li>
                            <li><a href="#">Studenti</a>
                            </li>
                            <li><a href="#">Business Man</a>
                            </li>
                        </ul>
                    </li>
                </ul>
    ...
    <div class="container">
        ...
        <ol class="breadcrumb">
            ...
            <li><a href="./index.php">Categorie</a>
            </li>
            <!-- Notare che questa è la pagina in cui ci troviamo,
          quindi il link dev'essere attivo!-->
    ...
    <div class="page-header">
      <h1>Avventura<small>  Scopri tutte le offerte.</small></h1>
</div> 
    ...
    <div class="container">
        <footer>
            ...
            <p class="pull-right"><a href="#">Top</a>
            </p>

            <p>© 2014, VenezianiDoc</p>
        </footer>
    </div>
    <!-- ./FOOTER -->
