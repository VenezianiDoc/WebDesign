...
<div class="container">
    ...
    <ol class="breadcrumb">
        ...
        <!-- pagina attiva-->
        <li class="active">Last minute</li>
    </ol>
</div>
<!-- /breadcrumbs -->
...
<div class="container">
    <div class="page-header">
        <h1>Last minute
            <small> Offerte fino all'ultimo secondo!</small>
        </h1>
    </div>
        ...
        <div class="row">
            <div class="col-xs-12 col-sm-6 col-md-3 col-lg-3">
                ...
                <div class="panel price panel-red">
                    ...
                    <div class="panel-body text-center">
                        <p class="lead" style="font-size:40px"><strong>159 €</strong></p>
                    </div>
            ...
            <div class="col-xs-12 col-sm-6 col-md-3 col-lg-3">
                ...
                <div class="panel price panel-blue">
                    ...
                    <div class="panel-body text-center">
                        <p class="lead" style="font-size:40px"><strong>109 €</strong></p>
                    </div>
                    <ul class="list-group list-group-flush text-center">
            ...
            <div class="col-xs-12 col-sm-6 col-md-3 col-lg-3">
                ...
                <div class="panel price panel-green">
                    ...
                    <div class="panel-body text-center">
                        <p class="lead" style="font-size:40px"><strong>59 €</strong></p>
                    </div>
                    <ul class="list-group list-group-flush text-center">
