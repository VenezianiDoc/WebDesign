        ...
        <div class="row text-center">
            <div class="hidden-xs col-lg-12 col-md-12 hidden-print">
                ...
                <div class="ui-group-buttons text-center">
                    ...
                    <div class="or"></div>
                    <button type="button" class="button btn btn-success" onClick="window.location.reload();">Avventura
                    </button>

                    <button type="button" class="btn btn-primary" onClick="window.location.reload();">Coppia</button>
                    <div class="or"></div>
                    <button type="button" class="button btn btn-success" onClick="window.location.reload();">Famiglia
                    </button>

                    <button type="button" class="btn btn-primary" onClick="window.location.reload();">Costume</button>
                    <div class="or"></div>
                    <button type="button" class="button btn btn-success" onClick="window.location.reload();">Sciarpa
                    </button>
                    <br>
                    <button type="button" class="btn btn-primary" onClick="window.location.reload();">Mare</button>
                    <div class="or"></div>
                    <button type="button" class="button btn btn-success" onClick="window.location.reload();">Montagna
                    </button>

                    <button type="button" class="btn btn-primary" onClick="window.location.reload();">Metropoli</button>
                    <div class="or"></div>
                    <button type="button" class="button btn btn-success" onClick="window.location.reload();">Sobborgo
                    </button>
                ...
                <div class="row">
                    ...
                    <div class="well">
                        <div class="media">
                            ...
                            <div class="media-body">
                                ...
                                <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Duis pharetra varius quam
                                    sit amet vulputate. Quisque mauris augue, molestie tincidunt condimentum vitae,
                                    gravida a libero <a href="musei/item1.php">[&hellip;]</a>
                                </p>
                    ...
                    <div class="well">
                        <div class="media">
                            ...
                            <div class="media-body">
                                <a href="musei/item1.php"><h4 class="media-heading">
                                        Offerta <?php echo rand(0, 55); ?></h4></a>
